...
if __name__ == '__main__':
    ...
    while True:
        ...
        if button_b_state == False:
            ...
            # Draw vector figures
            # A Button
            draw.rectangle((0,0, ((LCD.LCDWIDTH / 2) -2), ((LCD.LCDHEIGHT /2) -2)), outline=0, fill=255)
            # C Button
            draw.rectangle((0,((LCD.LCDWIDTH / 2) + 2), ((LCD.LCDWIDTH / 2) -2), ((LCD.LCDHEIGHT /2) -2)), outline=0, fill=255)
            print(LCD.LCDWIDTH)
            print(LCD.LCDHEIGHT)
            #draw.rectangle((24,2,44,22), outline=0, fill=0)
